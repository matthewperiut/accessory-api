...
public class ItemListener
{
    ...
    public void registerItems(ItemRegistryEvent event)
    {
        ...
        testGloves = new TestAccessoryWithRenderer(MOD_ID.id("test_gloves"), new GloveRenderer("assets/testmod/textures/armour/test.png"), "glove");
        rainbowGloves = new RainbowAccessory(MOD_ID.id("rainbow_gloves"), new RainbowGloveRenderer("assets/testmod/textures/armour/test.png"), "glove");
        ...
        testAll = new TestAccessory(MOD_ID.id("test_all"), "all");
